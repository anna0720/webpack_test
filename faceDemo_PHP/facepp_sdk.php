...
class Facepp
{
    ...
    ######################################################
    public $server          = 'http://api.cn.faceplusplus.com/';
    ...
    public $api_key         = '132863b61db8084df980f344b09251a4';        // set your API KEY or set the key static in the property
    public $api_secret      = 'OBOFVNSrLeJazlO-rRuhCgCQGkiOBV-j';        // set your API SECRET or set the secret static in the property
